                    ...
                    <section>
                                    <div class="container">
                                        <form action="{{ route('buscar-paquete') }}" method="GET" class="search-form" data-aos="fade-up" data-aos-delay="200">
                                            <br><br><h1 class="hero__title">BUSCAR PEDIDO</h1><br>
                                            <center><p class="imput-color"><input type="text" name="numero_paquete" id="nguia"></p></center>
                                            <center><button type="submit" class="button">BUSCAR PEDIDO</button></center><br><br>
                                        </form>
                                        ...
                                        <table class="container">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $paquete->direccion_salida }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>Código Postal:</td>
                                                    <td>{{ $paquete->codigo_postal }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Contenido del Paquete:</td>
                                                    <td>{{ $paquete->contenido_paquete }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Ancho:</td>
                                        ...
                                        @else
                                            <center><p>El paquete no se encontró.</p></center>
                                        @endif 
                                    </div>
                                </div>
                        </div>
