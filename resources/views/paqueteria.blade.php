                                        ...
                                        <div class="row align-items-center gx-5">
                                            <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                                <div class="bg-light p-4 rounded-4">
                                                    <p>Con nuestra función de búsqueda avanzada, puedes encontrar información detallada sobre el estado y la ubicación de tus paquetes en tiempo real. Simplemente ingresa el número de seguimiento proporcionado al realizar tu envío y accede instantáneamente a actualizaciones precisas sobre el progreso de tu entrega. Ya sea que estés esperando un paquete entrante o rastreando una entrega saliente, nuestra plataforma te brinda la tranquilidad de estar siempre informado sobre el estado de tus envíos.<p>
                                                </div>
                                            </div>
