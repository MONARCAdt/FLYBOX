...
.hero::before {
    ...
    width: 100%;
    height: 100%;
    background-image: linear-gradient(180deg, #0000008c 0%, #0000008c 100%), url('https://images.unsplash.com/photo-1580674285054-bed31e145f59?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
...
<body>
    ...
    <main>
        <section class="container about">
            <h2 class="subtitle">¿Qué te brindamos?</h2>
            <p class="about__paragraph">Nuestra prioridad es garantizar la total 
                satisfacción de todos nuestros clientes al utilizar nuestro servicio. 
                Por eso, contamos con:</p>

            <div class="about__main">
                <article class="about__icons">
                    <img src="https://media.istockphoto.com/id/1322156364/es/foto/camioneros-cargando-cajas-de-transporte-de-furgonetas.jpg?s=612x612&w=0&k=20&c=lF4BmglENVpDhyD335vf5AOeDwbSFAvAOecXgQ-YgZQ=" class="about__icon">
                    <h3 class="about__title">Seguridad</h3>
                    <p class="about__paragrah">Para nosotros, la seguridad de tu paquete 
                        no es solo una prioridad, es nuestra responsabilidad fundamental.
                         Por eso, te garantizamos su protección.</p>
                </article>

                <article class="about__icons">
                    <img src="https://media.istockphoto.com/id/1321485313/es/foto/drone-de-entrega-voladora-que-transfiere-la-caja-de-paqueter%C3%ADa-del-almac%C3%A9n-de-distribuci%C3%B3n-al.jpg?s=612x612&w=0&k=20&c=Lc0rWpHMjfJmnQwnBusZPhmn274NOndfNSSAxdU2lTM=" class="about__icon">
                    <h3 class="about__title">Rápidez</h3>
                    <p class="about__paragrah">Entendemos lo valioso que es tu tiempo y 
                        que deseas recibir tu paquete lo más rápido posible. Por eso, 
                        nos esforzamos al máximo para asegurar una entrega rápida. 
                        ¡Te garantizamos que llegan volando!</p>
                </article>

                <article class="about__icons">
                    <img src="https://media.istockphoto.com/id/1144424874/es/vector/manos-que-sostienen-el-planeta-tierra-para-el-cuidado-del-medio-ambiente.jpg?s=612x612&w=0&k=20&c=gymtdhrZMYr7hYgjL8KvpbG5SB62hRY_7_oZ7Te24wM=" class="about__icon">
                    <h3 class="about__title">Sostemiblidad</h3>
                    <p class="about__paragrah">La sostenibilidad es una prioridad 
                        para nosotros, ya que reconocemos que el planeta es nuestro 
                        hogar. Estamos plenamente comprometidos con el uso de energía 
                        y combustibles renovables.v</p>
                </article>
            </div>
        </section>
        ...
        <section class="knowledge">
            <div class="knowledge__container container">
                <div class="knowledege__texts">
                    <center><h2 class="subtitle">MISION</h2></center>
                    <center><p class="knowledge__paragraph">En FlyBox, nuestra principal prioridad es garantizar la seguridad y rapidez en el envío de productos para nuestros clientes y empresas asociadas. Nuestra misión consiste en asegurar que nuestros drones operen de manera funcional y efectiva, de modo que podamos brindar una experiencia satisfactoria a nuestros clientes y terceros.</p></center>
                </div>
                <div class="knowledege__texts">
                    <center><h2 class="subtitle">VISION</h2></center>
